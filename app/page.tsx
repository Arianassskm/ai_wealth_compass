    ...
    <main className="min-h-screen overflow-hidden">
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="relative">
                <Avatar className="h-8 w-8">
                  <AvatarImage src="/images/placeholder.svg" alt="User" />
      ...
      {showAnalysis && (
        <DisposableIncomeAnalysis
          ...
          totalExpenses={6320}
          incomeSources={[
            { name: '工资', amount: 8000, change: 5 },
            { name: '投资收益', amount: 2000, change: 10 },
          ]}
          expenses={[
            { name: '房租', amount: 3000, change: 0 },
            { name: '日常开销', amount: 2000, change: -5 },
            { name: '交通', amount: 500, change: 2 },
            { name: '其他固定支出', amount: 820, change: 3 },
          ]}
